...
**This repo is copied from https://github.com/CharlesShang/TFFRCNN, but some files is modified for python3 and tensorflow-1.11.0. The demo.py and train_net.py in faster_rcnn directory is OK on PASCAL-VOC-2007 using a VGG16 network.**
